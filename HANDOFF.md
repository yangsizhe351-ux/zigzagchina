...
- `ZC-013`：`READY`；用户已授权试行右侧抽屉主导航。基线 `cd749bbdbc957de13b39e6905a0373f7aa7e3aac` 受本地 tag `refs/tags/qa-pass/ZC-012-20260901-01` 保护；若用户不喜欢，仅 revert ZC-013 的单独实现提交，不改写历史。
