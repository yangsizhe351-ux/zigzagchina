...
- `ZC-013`：`DONE`；右侧抽屉与内页根因修复已本地集成，qa-gate 对精确 main 候选 `0a34ac7c9bbffc937e9f0f5eef52011a3fe778f2` 给出 PASS。封板记录正在接受一次精确复核，随后创建预声明 tag `refs/tags/qa-pass/ZC-013-20260901-01`；基线 `cd749bbdbc957de13b39e6905a0373f7aa7e3aac` 仍受 ZC-012 tag 保护。
