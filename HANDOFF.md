...
- `ZC-012`：`DONE`；封板候选 `3bb65750263b8339c190bc72066a8e41dd96fb4f` 已由同一 qa-gate 复核 PASS，P2 导航落点风险已接受，等待最终 tag。
...
本轮明确范围：保留当前熊猫双城首页图、图1新增介绍与 CTA 及现有视觉；恢复图2标题文案；按图3删除 `Experiences`、`Book Your Trip`，新增 `Practical FAQ`、`Contact Us`。不恢复已删除的实用指南功能，也不推送或部署。
