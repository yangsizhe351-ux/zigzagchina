...
export const content = {
  EN: {
    ...
    nav: ['About Us', 'Destinations', 'Practical FAQ', 'Contact Us'],
  ...
  FR: {
    ...
    nav: ['À propos', 'Destinations', 'FAQ pratique', 'Nous contacter'],
    kicker: 'Guide local privé · Chengdu + Chongqing', title: ['Découvrez', 'le sud-ouest de la Chine'], intro: 'Des journées privées et sur mesure, guidées par une équipe locale—pour les voyageurs internationaux en quête de vrais quartiers, de saveurs inoubliables et d’un rythme personnel.', heroPrimary: 'Vérifier vos dates', heroSecondary: 'Voir les expériences privées', explore: 'Explorer', scroll: 'Défiler pour explorer',
