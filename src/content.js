...
export const content = {
  EN: {
    ...
    teaserBody: 'Ease into Chengdu over tea and bold Sichuan flavours, then follow the rivers to Chongqing, where hills, bridges and neon reshape the night. ZigZag shows you both cities like a local.',
  ...
  FR: {
    ...
    teaserKicker: 'Un voyage, deux énergies', teaserTitle: ['Laissez la ville', 'vous surprendre.'], teaserBody: 'Commencez par le rythme paisible de Chengdu, puis suivez les rivières vers les nuits électriques de Chongqing. ZigZag vous ouvre les portes des deux villes.', begin: 'Commencer l’exploration', sectionLabel: '01 — Trouvez votre rythme',
  ...
  '中': {
    ...
    nav: ['目的地', '旅行体验', '规划行程', '旅行指南'], kicker: '探索不一样的中国', title: ['发现', '中国西部'], intro: '两座城市，无数种旅行感受。', explore: '探索', scroll: '向下探索', teaserKicker: '一次旅程，两种气质', teaserTitle: ['让这座城市', '带给你惊喜。'], teaserBody: '从成都的悠闲节奏出发，沿着江河一路向东，进入重庆灯火通明的夜晚。ZigZag 带你打开两座城市的第一扇窗。', begin: '开始探索', sectionLabel: '01 — 找到你的旅行节奏', city: { Chengdu: { eyebrow: '晨雾 · 茶 · 大熊猫', title: '成都', body: '慢下来的清晨、热辣的餐桌、古老的街巷和柔软的城市气质。', action: '探索慢生活城市' }, Chongqing: { eyebrow: '霓虹 · 江河 · 山城', title: '重庆', body: '流动的灯火、层叠的高架，以及一座向山而生的城市。', action: '进入山城夜色' } }, routeKicker: '为好奇的旅行者准备', routeTitle: ['走一条', '风景路线。'], viewRoutes: '查看全部路线', routes: ['第一次品尝四川', '一周双城之旅', '重庆夜游路线'], searchKicker: '搜索旅行内容', searchPlaceholder: '试试“火锅”、“熊猫”或“夜景”', noMatches: '暂时没有匹配内容。', cityComing: (city) => `${city}探索内容即将开放`, routeAdded: (route) => `已将“${route}”加入行程`, proofKicker: '更聪明的抵达方式', proofTitle: ['两座城市。', '一眼难忘的第一印象。'], proofBody: 'ZigZag 让中国西部之旅在预订前就变得鲜活，并为旅行者提供真正可执行的路线。', proofStats: [['02', '座标志性城市'], ['03', '种语言'], ['∞', '种旅行方式']], proofAction: '规划你的旅程', experienceKicker: '选择你的旅行感受', experienceTitle: ['凭直觉', '去旅行。'], experienceCards: [['茶与慢清晨', '成都', '01'], ['熊猫与自然', '成都', '02'], ['深夜火锅', '重庆', '03'], ['俯瞰山城灯火', '重庆', '04']], footerText: '为好奇的旅行者准备的成都与重庆旅行指南。', footerAction: '开始规划', waitlistTitle: '抢先获得第一批路线。', waitlistBody: '留下邮箱，接收实地测试后的旅行路线和城市笔记。', waitlistPlaceholder: '你的邮箱地址', waitlistButton: '加入名单', waitlistSuccess: '已加入名单，期待和你一起出发。', journey: '我的行程', emptyJourney: '行程还是空的', journeyHint: '选择一条路线，开始规划你的旅行。', clearJourney: '清空全部',
  },
};
