...
export const content = {
  EN: {
    ...
    kicker: 'Uncover the hidden gems of an enchanting land…',
    title: ['Explore', 'Southwestern China'],
    intro: 'Chilli & Chill Journeys',
    explore: 'Discover',
    ...
    city: {
      Chengdu: { eyebrow: 'Giant pandas · tea houses · Sichuan flavours', title: 'Chengdu', body: 'Tea houses at dawn, lively food streets and a city that knows how to slow down.', action: 'Experience Chengdu' },
      Chongqing: { eyebrow: 'Spicy hotpot · vibrant rivers & bridges', title: 'Chongqing', body: 'Neon-lit rivers, hillside streets and views that make the city feel almost impossible.', action: 'See Chongqing after dark' },
    },
    ...
    aboutKicker: 'About us', aboutTitle: ['Travel your way.', 'With a local perspective.'], aboutBody: 'Choose from the essential tastes, rhythms and views of Chengdu and Chongqing, then combine them into a private journey shaped around your pace.', aboutAction: 'Meet the cities',
  ...
  FR: {
    ...
    kicker: 'Découvrez les trésors cachés d’une terre envoûtante…', title: ['Découvrez', 'le sud-ouest de la Chine'], intro: 'Chilli & Chill Journeys', explore: 'Explorer', scroll: 'Défiler pour explorer',
